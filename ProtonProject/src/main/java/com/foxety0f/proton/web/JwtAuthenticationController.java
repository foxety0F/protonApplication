...
public class JwtAuthenticationController {
	...
	@RequestMapping(value = "/proton/getSelf", method = RequestMethod.POST)
	public ResponseEntity<?> getSelf(Principal principal) {
		if (principal != null) {
			final UserDetailsProton user = (UserDetailsProton) SecurityContextHolder.getContext().getAuthentication()
					.getPrincipal();
