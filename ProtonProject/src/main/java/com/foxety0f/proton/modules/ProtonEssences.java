...
public enum ProtonEssences {
	 ...
	 * 
	 * */
	META_UPDATE_RELATION(206, "META_UPDATE_RELATION"),
	
	/**
	 * 
	 * */
	CONSTRUCTOR_CREATE_REPORT(301, "CONSTRUCTOR_CREATE_REPORT"),
	
	/**
	 * 
	 * */
	CONSTRUCTOR_CREATE_REPORT_PART_COLUMN(302, "CONSTRUCTOR_CREATE_REPORT_PART_COLUMN"),
	
	/**
	 * 
	 * */
	CONSTRUCTOR_CREATE_REPORT_PART_CONDITION(303, "CONSTRUCTOR_CREATE_REPORT_PART_CONDITION"),
	
	/**
	 * 
	 * */
	CONSTRUCTOR_CREATE_REPORT_PART_SEPARATION(304, "CONSTRUCTOR_CREATE_REPORT_PART_SEPARATION"),
	
	/**
	 * 
	 * */
	CONSTRUCTOR_CREATE_REPORT_PART_VERSION(305, "CONSTRUCTOR_CREATE_REPORT_PART_VERSION"),
	
	/**
	 * 
	 * */
	CONSTRUCTOR_UPDATE_REPORT(306, "CONSTRUCTOR_UPDATE_REPORT"),
	
	/**
	 * 
	 * */
	CONSTRUCTOR_UPDATE_REPORT_PART_COLUMN(307, "CONSTRUCTOR_UPDATE_REPORT_PART_COLUMN"),
	
	/**
	 * 
	 * */
	CONSTRUCTOR_UPDATE_REPORT_PART_CONDITION(308, "CONSTRUCTOR_UPDATE_REPORT_PART_CONDITION"),
	
	/**
	 * 
	 * */
	CONSTRUCTOR_UPDATE_REPORT_PART_SEPARATION(309, "CONSTRUCTOR_UPDATE_REPORT_PART_SEPARATION"),
	
	/**
	 * 
	 * */
	CONSTRUCTOR_UPDATE_REPORT_PART_VERSION(310, "CONSTRUCTOR_UPDATE_REPORT_PART_VERSION"),
