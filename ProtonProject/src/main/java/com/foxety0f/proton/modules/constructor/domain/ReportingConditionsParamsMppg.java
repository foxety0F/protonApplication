...
public class ReportingConditionsParamsMppg {
	...
	if (getClass() != obj.getClass())
	    return false;
	ReportingConditionsParamsMppg other = (ReportingConditionsParamsMppg) obj;
	if (cDate == null) {
	    if (other.cDate != null)
		return false;
	...
	return "ReportingConditionsParamsMppg [id=" + id + ", reportConditionId=" + reportConditionId
		+ ", opsParameterId=" + opsParameterId + ", value=" + value + ", valueSeq=" + valueSeq + ", customName="
		+ customName + ", isActive=" + isActive + ", cDate=" + cDate + ", uDate=" + uDate + "]";
    }
