...
public class ConstructorAvailColumnParams {
    ...
    private List<ConstructorAvailColumnParameterReplacer> columnReplacer;
    ...
    public List<ConstructorAvailColumnParameterReplacer> getColumnReplacer() {
	return columnReplacer;
    }

    public void setColumnReplacer(List<ConstructorAvailColumnParameterReplacer> columnReplacer) {
	...
	if (getClass() != obj.getClass())
	    return false;
	ConstructorAvailColumnParams other = (ConstructorAvailColumnParams) obj;
	...
	return "ConstructorAvailColumnParams [id=" + id + ", columnType=" + columnType + ", title=" + title
		+ ", description=" + description + ", pseudoLogic=" + pseudoLogic + ", columnReplacer=" + columnReplacer
		+ ", isActive=" + isActive + ", isGroup=" + isGroup + "]";
    }
