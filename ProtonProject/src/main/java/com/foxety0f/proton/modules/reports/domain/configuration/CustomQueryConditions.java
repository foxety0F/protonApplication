...
public class CustomQueryConditions {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CustomQueryConditions other = (CustomQueryConditions) obj;
		if (cDate == null) {
			if (other.cDate != null)
				return false;
	...
	public String toString() {
		return "CustomQueryConditions [id=" + id + ", conditionCode=" + conditionCode + ", name=" + name
				+ ", description=" + description + ", cDate=" + cDate + ", uDate=" + uDate + ", userId=" + userId + "]";
	}
