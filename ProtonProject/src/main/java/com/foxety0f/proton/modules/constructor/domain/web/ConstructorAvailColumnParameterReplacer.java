...
public class ConstructorAvailColumnParameterReplacer {
	...
	if (getClass() != obj.getClass())
	    return false;
	ConstructorAvailColumnParameterReplacer other = (ConstructorAvailColumnParameterReplacer) obj;
	if (id == null) {
	    if (other.id != null)
		return false;
	...
	return "ConstructorAvailColumnParameterReplacer [id=" + id + ", operationId=" + operationId + ", systemId="
