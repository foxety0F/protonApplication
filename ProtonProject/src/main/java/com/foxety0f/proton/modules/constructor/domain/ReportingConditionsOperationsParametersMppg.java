...
public class ReportingConditionsOperationsParametersMppg {
	...
	if (getClass() != obj.getClass())
	    return false;
	ReportingConditionsOperationsParametersMppg other = (ReportingConditionsOperationsParametersMppg) obj;
	if (cDate == null) {
	    if (other.cDate != null)
		return false;
	...
	return "ReportingConditionsOperationsParametersMppg [id=" + id + ", paramId=" + paramId + ", columnOpId="
