...
public class ReportingConditions {
	...
	if (getClass() != obj.getClass())
	    return false;
	ReportingConditions other = (ReportingConditions) obj;
	if (cDate == null) {
	    if (other.cDate != null)
		return false;
	...
	return "ReportingConditions [id=" + id + ", reportId=" + reportId + ", columnId=" + columnId + ", operationId="
